...
const Dashboard = () => {
  ...
  return (
    /* CORRECTION : Remplacement de p-8 par p-4 md:p-8 pour un meilleur espacement mobile */
    <div
    ...
    >
      ...
      <meta
        name="description"
        content="View your developer roadmap progress, add tasks, purges, and manage JSON imports on the Dev Tasks (devtasks) control dashboard."
      />
      <meta
        name="keywords"
        content="devtasks, dev tasks, developer dashboard, task statistics, engineering todo"
      />
      ...
      <div className="max-w-6xl w-full mx-auto flex flex-col h-full">
        <header className="shrink-0 mb-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
          <div>
            ...
            <p className="text-gray-400 font-medium mb-6">
              Manage your engineering workflow
            </p>
        ...
        {/* CORRECTION : Ajout de hidden md:block pour éviter que l'élément FLOW ne casse la hauteur sur mobile */}
