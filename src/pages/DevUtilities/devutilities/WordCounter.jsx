...
const WordCounter = () => {
  ...
  const handleSample = () => {
    setText("Hello world this is a sample text for word counter");
  };
  ...
  const buttons = [{ label: "Clear", onClick: handleClear }];
  ...
  return (
    ...
    >
      <title>Word Counter — DevTasks</title>
      <meta
        name="description"
        content="A fast and simple word and character counter tool for developers and writers."
      />
